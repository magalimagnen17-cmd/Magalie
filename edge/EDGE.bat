@echo off
title Microsoft Edge  -  sauvegarde, neutralisation ou desinstallation
setlocal
REM ==========================================================
...
REM ==========================================================
set "PS1=%TEMP%\Gerer-Edge.ps1"
set "PWSH=%SystemRoot%\System32\WindowsPowerShell\v1.0\powershell.exe"
if not exist "%PWSH%" set "PWSH=powershell.exe"
more +25 "%~f0" > "%PS1%"
if not exist "%PS1%" goto ERR
findstr /c:"EDGE : SAUVEGARDER, NEUTRALISER OU DESINSTALLER" "%PS1%" >nul || goto ERR
